//! Suomi (`fi`). Textual only — Symbolic glyphs fall back to English.
...
pub(crate) fn translate(key_id: &str, style: LabelStyle) -> Option<Cow<'static, str>> {
    ...
    let s: &'static str = match key_id {
        ...
        "key_arrow_up" => "Ylös",
        "key_arrow_down" => "Alas",
        "key_arrow_left" => "Vasen",
        "key_arrow_right" => "Oikea",
        ...
        | "mod_shift_chromeos" | "mod_shift_android" => "Vaihto",
        "mod_alt_mac" => "Optio",
