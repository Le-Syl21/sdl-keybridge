...
pub(crate) fn translate(key_id: &str, style: LabelStyle) -> Option<Cow<'static, str>> {
    ...
    let s: &'static str = match (key_id, style) {
        ...
        ("key_arrow_up", Textual) => "Góra",
        ("key_arrow_up", Symbolic) => "↑",
        ("key_arrow_down", Textual) => "Dół",
        ("key_arrow_down", Symbolic) => "↓",
        ("key_arrow_left", Textual) => "Lewo",
        ("key_arrow_left", Symbolic) => "←",
        ("key_arrow_right", Textual) => "Prawo",
        ...
        ("key_pause", _) => "Pauza",
        ("key_menu", _) => "Menu",
        ("key_application", _) => "Aplikacja",

        ("key_shift_left", Textual) => "Shift lewy",
        ("key_shift_left", Symbolic) => "⇧",
        ("key_shift_right", Textual) => "Shift prawy",
        ("key_shift_right", Symbolic) => "⇧",
        ("key_control_left", Textual) => "Ctrl lewy",
        ("key_control_left", Symbolic) => "⌃",
        ("key_control_right", Textual) => "Ctrl prawy",
        ("key_control_right", Symbolic) => "⌃",
        ("key_alt_left", Textual) => "Alt lewy",
        ("key_alt_left", Symbolic) => "⌥",
        ("key_alt_right", Textual) => "Alt prawy",
        ("key_alt_right", Symbolic) => "⌥",
        ("key_altgr", Textual) => "AltGr",
        ("key_altgr", Symbolic) => "⌥",
        ("key_gui_left", Textual) => "Cmd lewy",
        ("key_gui_left", Symbolic) => "◇",
        ("key_gui_right", Textual) => "Cmd prawy",
        ...
        ("mod_gui_chromeos", Textual) => "Szukaj",
